            ...
            Column(
              ...
              children: <Widget>[
                ...
                TextFormField(
                  ...
                  enabled: false,
                  decoration:
                      const InputDecoration(labelText: 'Data da Consulta'),
                ),
                const SizedBox(height: 10),
                TextFormField(
                  controller: _motivo,
                  decoration:
                      const InputDecoration(labelText: 'Motivo do Atestado'),
                  maxLines: 4,
                ),
                ...
                TextFormField(
                  ...
                  decoration:
                      const InputDecoration(labelText: 'Dias de Afastamento'),
                ),
                const SizedBox(height: 10),
                TextFormField(
                  controller: _cidade,
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    Timer(const Duration(milliseconds: 1000), () {
                      ...
                      sendNotification(tokenFirebase, "Novo Atestado",
                          '${_diasAfastamento.text} dias de afastamento');
