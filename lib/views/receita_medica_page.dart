...
class ReceitaMedicaPage extends StatefulWidget {
  const ReceitaMedicaPage({required this.userToken, required this.newAtestado, Key? key}) : super(key: key);
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Dozagens do Medicamento'),
            ),
            const SizedBox(height: 10),
            TextFormField(
              readOnly: true,
